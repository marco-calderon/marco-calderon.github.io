...
category:
  - web
  - mobile
imgUrl: /wokelo-ai/thumb.png
description: AI agent for creating research documentation.
...
The technologies that I used here were React and TailwindCSS, for both the web application and the website.

Wokelo is an interesting project in which I worked with their development team to deliver a great integration between the backend and the frontend. I also suggested some changes that improved the performance of the application while I  was developing the frontend side.
