      ...
      <section data-aos="fade-up">
        ...
        >
          ...
          <p className="mt-5 mb-4 px-2 lg:px-20 py-4 lg:py-20">
            ...
            programming for web applications. I like working on complex projects
            where Front end and Back end interact with each other, dealing with
            the complexity of integrating REST APIs, external services, and data
            persistence layers. I&apos;m always happy to tackle new programming
            languages, frameworks, and technologies and keep up to date with
          ...
          <div className="row">
            ...
            <div className="flex flex-col gap-4 px-4 lg:px-20">
              <div className="flex flex-col gap-2 mb-1">
                ...
                <p>
                  Internet of Things - Human-centric App for Kinetic Wearables.
                </p>
              </div>
