...
const Hero: React.FC = () => {
  return (
    <section className="relative h-screen min-h-auto md:min-h-[800px] flex items-center justify-center text-white background-animated px-5 md:px-0">
      <div className="max-w-auto w-auto lg:w-[1300px] lg:max-w-[1300px] flex flex-col items-start z-10">
      ...
      <Image
        src="/hero-waves.svg"
        alt="Hero Image"
        className="absolute inset-0 object-cover object-center object- w-full h-full opacity-60"
        width={1920}
        height={1080}
        priority
      />

      <div className="absolute bottom-0 left-0 right-0 h-2/4 bg-gradient-to-b from-transparent to-black"></div>
    </section>
  );
};
